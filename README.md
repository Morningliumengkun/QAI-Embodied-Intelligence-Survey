...
- [`Extraction_Criteria.md`](Data/Extraction_Criteria.md): The extraction criteria used to extract the relevant information from the selected papers to answer the research questions. We presented the extraction criteria in a markdown file for better readability.
